  ...
  <div class="bg-neutral-primary-soft border-2 border-default rounded-base shadow-lg overflow-hidden">
    ...
    <div class="bg-linear-to-r from-neutral-primary via-neutral-primary-soft to-neutral-primary-soft px-4 py-2 md:px-6 md:py-5 border-b-2 border-default shadow-sm">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h1 class="text-xl md:text-2xl font-bold text-heading">Dashboard Karyawan</h1>
    ...
    <div class="p-3 space-y-6">
      ...
      <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <!-- Total Cuti -->
          <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-4 sm:p-5 hover:shadow-lg hover:border-default-medium transition-all duration-300 transform hover:-translate-y-1">
          ...
          <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-4 sm:p-5 hover:shadow-lg hover:border-default-medium transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-start justify-between">
              ...
              <div class="p-2 bg-red-100 dark:bg-red-900/30 rounded-base">
        ...
        <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
            ...
            ?>
              ...
              ?>
                <div class="bg-neutral-primary border border-default rounded-base p-4 flex items-center gap-3 hover:shadow-md transition-shadow">
                  <div class="p-2 <?= $colors['bg'] ?> rounded-base">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-4">
          ...
          <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-lg p-5">
            <div class="flex items-center gap-3">
              <div class="p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-base">
        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              <div class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-base">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Total Hadir</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['bulan_ini']['total_attendance'] ?? 0 ?></p>
              </div>
            </div>

            <!-- Tepat Waktu -->
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              <div class="p-2 bg-green-100 dark:bg-green-900/30 rounded-base">
              ...
              <div>
                ...
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['bulan_ini']['on_time'] ?? 0 ?></p>
              </div>
            </div>

            <!-- Terlambat -->
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              <div class="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-base">
              ...
              <div>
                ...
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['bulan_ini']['late'] ?? 0 ?></p>
              </div>
            </div>

            <!-- Belum Checkout -->
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
                <div class="p-2 bg-yellow-100 dark:bg-yellow-900/30 rounded-base">
              ...
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Belum Checkout</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['bulan_ini']['not_checkout'] ?? 0 ?></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <?php else: ?>
          <div class="space-y-3">
            ...
            ?>
              <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-4 transition-all hover:shadow-md">
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4 flex-1">
                    <!-- Status Icon -->
                    <div class="p-3 hidden md:block <?= $config['bg'] ?> rounded-lg <?= $config['text'] ?>">
                      <?= $config['icon'] ?>
                    </div>
                    <!-- Info -->
                    <div class="flex-1">
