                            ...
                            <tr class="bg-neutral-primary border-b border-default">
                                ...
                                <td class="px-6 py-4">
                                    <?php if ($leave['attachment_file']): ?>
                                        <a href="<?= url('/download/leave/' . $leave['id']) ?>"
                                            target="_blank"
...
<script>
    ...
    `;
        ...
        if (leave.attachment_file) {
            content += `<div><strong>Lampiran:</strong> <a href="<?= url('/download/leave/') ?>${leave.id}" target="_blank" class="text-blue-600">Lihat File</a></div>`;
        }
