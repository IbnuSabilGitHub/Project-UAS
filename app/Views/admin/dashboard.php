<div class="p-4 sm:ml-64 mt-14 bg-neutral-primary">
  ...
  <?php if (!empty($success)): ?>
    <div id="alert-success" class="flex items-center p-4 mb-4 text-green-800 border border-green-300 rounded-base bg-green-50" role="alert">
  ...
  <div class="bg-neutral-primary-soft border-2 border-default rounded-base shadow-lg overflow-hidden">

    <!-- Header with Sidebar Color -->
    <div class="bg-linear-to-r from-neutral-primary via-neutral-primary-soft to-neutral-primary-soft px-4 py-2 md:px-6 md:py-5 border-b-2 border-default shadow-sm">
      <div class="flex items-center gap-3">
        <div class="p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-base">
        ...
        <div>
          <h1 class="text-xl md:text-2xl font-bold text-heading">Dashboard Admin</h1>
        </div>
      </div>
    </div>
    ...
    <div class="p-3 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <!-- Total Karyawan Card -->
        <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 hover:shadow-lg hover:border-default-medium transition-all duration-300 transform hover:-translate-y-1">
          <div class="flex items-start justify-between">
            <div>
              <p class="text-body text-sm font-medium mb-2 lg:mb-3">Total Karyawan</p>
              <p class="text-3xl md:text-4xl lg:text-5xl font-bold text-heading"><?= $statsKaryawan['total'] ?? 0 ?></p>
            </div>
            <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-base">
        ...
        <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 hover:shadow-lg hover:border-default-medium transition-all duration-300 transform hover:-translate-y-1">
          <div class="flex items-start justify-between">
            <div>
              <p class="text-body text-sm font-medium mb-2 lg:mb-3">Akun Aktif</p>
              <p class="text-3xl md:text-4xl lg:text-5xl font-bold text-heading"><?= $statsKaryawan['active'] ?? 0 ?></p>
            </div>
            <div class="p-3 bg-green-100 dark:bg-green-900/30 rounded-base">
        ...
        <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 hover:shadow-lg hover:border-default-medium transition-all duration-300 transform hover:-translate-y-1">
          <div class="flex items-start justify-between">
            <div>
              <p class="text-body text-sm font-medium mb-2 lg:mb-3">Bergabung Bulan Ini</p>
              <p class="text-3xl md:text-4xl lg:text-5xl font-bold text-heading"><?= $statsKaryawan['new_this_month'] ?? 0 ?></p>
            </div>
            <div class="p-3 bg-purple-100 dark:bg-purple-900/30 rounded-base">
      ...
      <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 py-2">
          <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
            <div class="p-3 bg-green-100 dark:bg-green-900/30 rounded-base">
            ...
            <div>
              ...
              <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsKaryawan['active'] ?? 0 ?></p>
            </div>
          </div>

          <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
            <div class="p-3 bg-orange-100 dark:bg-orange-900/30 rounded-base">
            ...
            <div>
              ...
              <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsKaryawan['inactive'] ?? 0 ?></p>
            </div>
          </div>

          <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
            <div class="p-3 bg-red-100 dark:bg-red-900/30 rounded-base">
            ...
            <div>
              ...
              <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsKaryawan['resigned'] ?? 0 ?></p>
            </div>
          </div>
        </div>
      </div>
            ...
            ?>
              <div class="group">
                <div class="flex items-center justify-between mb-2">
                  ...
                  <span class="text-xs font-bold text-heading bg-white/50 dark:bg-neutral-primary-soft px-2 py-1 rounded-base"><?= $count ?></span>
                </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            <!-- Pending -->
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              <div class="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-base group-hover:bg-orange-200 dark:group-hover:bg-orange-900/50 transition-colors">
              ...
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Pending</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsLeave['pending'] ?? 0 ?></p>
              </div>
            </div>

            <!-- Approved -->
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              <div class="p-2 bg-green-100 dark:bg-green-900/30 rounded-base group-hover:bg-green-200 dark:group-hover:bg-green-900/50 transition-colors">
              ...
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Approved</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsLeave['approved'] ?? 0 ?></p>
              </div>
            </div>

            <!-- Rejected -->
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              <div class="p-2 bg-red-100 dark:bg-red-900/30 rounded-base group-hover:bg-red-200 dark:group-hover:bg-red-900/50 transition-colors">
        ...
        <div class="bg-linear-to-br from-neutral-primary-soft to-neutral-primary border-2 border-default rounded-base p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 py-2">
            ...
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              ...
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Tepat Waktu</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['on_time'] ?? 0 ?></p>
              </div>
            </div>
            ...
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              ...
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Terlambat</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['late'] ?? 0 ?></p>
              </div>
            </div>
            ...
            <div class="bg-white/30 dark:bg-neutral-primary-soft backdrop-blur-sm border border-default rounded-base p-5 flex items-center gap-4 transition-colors">
              ...
              <div>
                <p class="text-xs text-body uppercase tracking-wide">Tidak Hadir</p>
                <p class="text-2xl lg:text-3xl font-bold text-heading"><?= $statsAttendance['absent'] ?? 0 ?></p>
              </div>
            </div>
          </div>
        </div>
